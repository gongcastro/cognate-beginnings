...
# import results
comp_fit1 <- readRDS(here("Results", "comp_fit1.rds"))
comp_selection <- readRDS(here("Results", "comp_selection.rds"))
...
Table \@ref(tab:resultscomp) shows the outcomes of the model.

```{r resultscomp, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
