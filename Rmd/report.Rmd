...
```{r items_list, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=4, out.width="100%"}
items %>% 
  pivot_wider(
...
```{stan stan_model, output.var="model"}
...
```{r vocabulary_comprehension, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r vocabulary_production, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r vocabulary_long_comprehension, message=FALSE, warning=FALSE, paged.print=FALSE}
vocabulary$long %>% 
...
```{r vocabulary_long_production, message=FALSE, warning=FALSE, paged.print=FALSE}
vocabulary$long %>% 
...
```{r ppc, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=3, fig.width=6}
...
```{r random_participant, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r re_item, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r emmeans, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r diagnostics_traceplots, message=FALSE, warning=FALSE, paged.print=FALSE}
