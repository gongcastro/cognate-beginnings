...
rope_coefs %>% 
    ...
    annotate(
        ...
        label = paste0(
            ...
            "Median = ", round(median(rope_coefs$estimate), 3)
        ),
        x = median(rope_coefs$estimate)-0.2,
        y = 4,
        hjust = 1,
        vjust = 1.2,
        size = 4.5,
    ...
    annotate(
        geom = "curve",
        x = median(rope_coefs$estimate)-0.2,
        xend = median(rope_coefs$estimate)-0.01,
        size = 1,
        y = 3.6,
        yend = 3.5,
        colour = pal_d3()(4)[4],
    ...
    labs(
        x = "Standard regression coefficient (logit scale)\n(Excluding intercepts and predictor age)",
        y = "Study"
    ) +
