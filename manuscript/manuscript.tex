...
equivalent /\textipa{"gat}/--/\textipa{"ga.to}/ {[}\emph{cat}{]}, which
...
/\textipa{"gos}/--/\textipa{"pe.ro}/ {[}\emph{dog}{]} would be
different. Given the low phonological similarity between both
word-forms, an exposure to \textipa{"gos} will result in a weak
activation of /\textipa{"pe.ro}/ leading to such exposure counting as a
learning instance for /\textipa{"gos}/ (which the child was exposed to),
but not for /\textipa{"pe.ro}/. While
/\textipa{"gat}/--/\textipa{"ga.to}/ will benefit from phonological
co-activation, /\textipa{"gos}--\textipa{"pe.ro}/ will not. If the child
...
/\textipa{"mar}/--/\textipa{"mar}/, \emph{sea})
(\protect\hyperlink{ref-floccia2018introduction}{Floccia et al., 2018};
