...
## Posterior draws and bi-variate scatterplots
...
titles <- c("Comprehension",
            ...
            "Age × Exposure",
            "Age × Levenshtein",
            "Exposure × Levenshtein",
            "Age × Exposure × Levenshtein")

posterior <- as.array(model_fit_4)
np <- nuts_params(model_fit_4) 
...
color_scheme_set(c(clrs[c(4, 4, 3, 2, 1)], "white"))
