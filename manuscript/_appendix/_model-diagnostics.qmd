...
```{r tbl-ppc}
#| label: tbl-ppc
#| tbl-cap: "Model posterior predictive checks (PPC). Bars indicate the observed proportion of responses to each category (No, Understands, and Understands and Says). Blue dots and error bars represent the mean proportion of responses simulated from the posterior for each category, and its 95\\% interval."
#| eval: true
#| echo: false
#| warning: false
#| message: false
