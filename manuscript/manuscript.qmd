...
fig_data <- model_epreds |> 
    reframe(.median = mean(.value),
            .lower = qi(.value, .width = 0.95)[,1],
            .upper = qi(.value, .width = 0.95)[,2],
