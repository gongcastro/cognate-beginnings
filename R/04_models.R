...
fit_models_comp <- function(
    ...
    formulas <- list(
        f_0 = bf(
            understands ~ 1 + age + frequency_center +
                (1 + age | te) +
                (1 + frequency_center | id),
            family = bernoulli("logit")
        ),
        f_1 = bf(
            understands ~ 1 + age + frequency_center + doe_center +
                (1 + age + doe_center | te) +
                (1 + frequency_center | id),
            family =  bernoulli("logit")
        ),
        f_2 = bf(
            understands ~ 1 + age + frequency_center + doe_center*cognate +
                (1 + age + doe_center*cognate | te) +
...
fit_models_prod <- function(
    ...
    formulas <- list(
        f_0 = bf(
            produces ~ 1 + age + frequency_center +
                (1 + age | te) +
                (1 + frequency_center | id),
            family = bernoulli("logit")
        ),
        f_1 = bf(
            produces ~ 1 + age + frequency_center + doe_center +
                (1 + age + doe_center | te) +
                (1 + frequency_center | id),
            family =  bernoulli("logit")
        ),
        f_2 = bf(
            produces ~ 1 + age + frequency_center + doe_center*cognate +
                (1 + age + doe_center*cognate | te) +
                (1 + frequency_center + doe_center | id),
            family =  bernoulli("logit")
        )
