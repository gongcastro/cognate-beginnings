...
fit_prior <- brm(formula = bf(proportion ~ inv_logit(asym) * inv(1 + exp((mid - age_bin) * exp(steep))),
                              asym ~ 1,
                              mid ~ 1 + bilingualism*item_dominance*cognate + (1 | meaning),
                              steep ~ 1 + bilingualism*item_dominance*cognate + (1 | meaning),
                              phi ~ 1,
                              nl = TRUE,
...
posterior <- fit_prior %>%
  ...
  mutate(.label = case_when(.variable %in% "b_asym_Intercept" ~ "Asymptote\n(Intercept)",
                            ...
                            .variable %in% "b_steep_cognate1" ~ "Cognateness (Slope)",
                            ...
                            .variable %in% "b_steep_bilingualism:dominance1:cognate1" ~ "Bilingualism \U000D7 Dominance \U000D7 Cognateness\n(Slope)",
         ...
         class = case_when(.variable %in% c("b_asym_Intercept", "b_steep_Intercept", "b_mid_Intercept") ~ "Logistic\n(Intercept, fixed)",
                           .variable %in% c("b_mid_bilingualism", "b_mid_item_dominance1", "b_mid_cognate1", "b_mid_bilingualism1:item_dominance1", "b_mid_bilingualism:cognate1",  "b_mid_item_dominance1:cognate1", "b_mid_bilingualism1:item_dominance1:cognate1", "b_mid_frequency") ~ "Mid-point",
                           .variable %in% c("b_steep_bilingualism", "b_steep_item_dominance1", "b_steep_cognate1", "b_steep_bilingualism1:item_dominance1", "b_steep_bilingualism:cognate1",  "b_steep_item_dominance1:cognate1", "b_steep_bilingualism1:item_dominance1:cognate1", "b_steep_frequency") ~ "Steepness",
